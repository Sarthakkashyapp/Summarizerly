import { BrainCircuit, FileOutputIcon, FileText, MoveRight } from "lucide-react"
...
export default function HowItWorksSection() {
    return <section className="relative overflow-hidden bg-gray-50">
        <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
          <div
            className="relative left-[calc(50%-3rem)] aspect-[155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
          ...
          <div className="text-center mb-18">
            ...
            className="font-bold text-xl uppercase mb-4 text-blue-400">How it works</MotionH2>
            <MotionH3 
              initial={{opacity: 0, y: 20}}
              whileInView={{opacity: 1, y: 0}}
                   ...
                   className="relative flex items-stretch" key={idx}>
                    ...
                    {idx < steps.length -1 && (
                        <MotionDiv 
                         ...
                         className="hidden md:block absolute top-1/2 -right-4 transform -transition-y-1/2 z-10">
                           <MoveRight
                             size={32}
                             strokeWidth={1}
...
function StepItem({icon, label, description}: Step) {
    return <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-sm border-2 border-white/10 hover:border-blue-500/50 transition-colors group w-full">
