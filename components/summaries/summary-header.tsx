...
export default function SummaryHeader({title, createdAt, readingTime} : {title:string, createdAt: string, readingTime: any}) {
    return (
        <div className="flex gap-4 mb-4 justify-between">
            <div className="space-y-6">
                <div className="flex flex-wrap items-center gap-4">
                    <Badge
                        ...
                        rounded-full hover:bg-white/90 transition-all duration-200 hover:shadow-md text-blue-500"
                    >
            ...
            <div className="self-start">
                ...
                <Button 
                    variant="link"
                    size="sm" 
                    className="group flex items-center gap-1 sm:gap-2 hover:bg-white/80 backdrop-blur-xs rounded-full transition-all duration-200 shadow-xs
                    hover:shadow-md border border-blue-100/30 bg-blue-100 px-2 sm:px-3 hover:no-underline hover:cursor-pointer"
                >
